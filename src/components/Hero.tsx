  ...
  return (
    <section className="w-full min-h-[90vh] flex flex-col justify-center items-center px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full flex flex-col items-center">
        ...
        {/* Animated decorative elements - organized with better positioning */}
        ...
        {/* Animated blobs for visual interest - repositioned for better balance */}
        ...
        {/* Description with refined typography - slightly shorter for better focus */}
        <p className="text-lg md:text-xl text-center max-w-xl text-gray-700 fade-in mb-10 leading-relaxed" style={{ animationDelay: '0.5s' }}>
